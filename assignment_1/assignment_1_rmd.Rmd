...
studentised.res <- ymx-fittedvalues
for(l in 1:n.post){
...
par(mfrow=c(1,2))
plot(seq_along(studentised.res.m),studentised.res.m,xlab="Index",ylab="Bayesian studentised residual")
plot(seq_along(studentised.res.m),rowMeans(fittedvalues),xlab="Index",ylab="Bayesian studentised residual")
