...
lin.mod.final <- inla(data$house.Y.house.price.of.unit.area ~ data$X1 + data$X2 + data$X3 + data$X4 + data$X5 + data$X6 + 
...
plot(density(post.pred.samples),type ="l",xlab="logprice",ylab="Density",
