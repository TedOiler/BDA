...
res.p = coda.samples(jm.p, variable.names=coef.p, n.iter=5e6, thin=500)
summary(res.p)
...
summary(lin.mod1)
plot(lin.mod1$marginals.fixed$`(Intercept)`, type ="l",xlab="x",ylab="Density",
main='Posterior density of beta0')
plot(lin.mod1$marginals.fixed$x1, type ="l",xlab="x",ylab="Density",
main='Posterior density of beta1')
plot(lin.mod1$marginals.fixed$x2, type ="l",xlab="x",ylab="Density",
main='Posterior density of beta2')
plot(lin.mod1$marginals.fixed$x3, type ="l",xlab="x",ylab="Density",
main='Posterior density of beta3')
plot(lin.mod1$marginals.fixed$x4, type ="l",xlab="x",ylab="Density",
main='Posterior density of beta4')
plot(lin.mod1$marginals.fixed$x5, type ="l",xlab="x",ylab="Density",
main='Posterior density of beta5')
plot(lin.mod1$marginals.fixed$x6, type ="l",xlab="x",ylab="Density",
main='Posterior density of beta6')
```
