...
# }"
# 
# prior.omega <- list(mean.intercept = 0, prec.intercept = 1/(20^2))
# prior.beta1 <- list(mean.intercept = 0, prec.intercept = 1/(10^2))
# prior.beta2 <- list(mean.intercept = 0, prec.intercept = 1/(10^2))
# prior.beta3 <- list(mean.intercept = 0, prec.intercept = 1/(10^2))
# prior.beta4 <- list(mean.intercept = 0, prec.intercept = 1/(10^2))
# 
...
ggarrange(d3.1, d3.2, d3.3, d3.4, ncol=2, nrow=2) %>%
