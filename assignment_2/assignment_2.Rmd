...
```{r 2.e}
res.d2 <- compute.replicates(fit=fit.d2, iter=1e4, var.name="Fire.rep", chains=5)
res.d3 <- compute.replicates(fit=fit.d3, iter=1e4, var.name="Fire.rep", chains=5)
res.e1 <- compute.replicates(fit=fit.e1, iter=1e4, var.name="Fire.rep", chains=5)
