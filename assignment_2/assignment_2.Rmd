...
ggarrange(p1.1, p1.2, p1.3, p1.4, ncol=2, nrow=2, common.legend=TRUE) %>%
  annotate_figure(top=text_grob("Exploratory Data Analysis"))
...
load(file='./earthScot.RData')
earthQ <- data.table(earthQ)
# inits.s <- list(list(lambda=rnorm(1,mean=0,sd=1)),
#                 list(lambda=rnorm(1,mean=0,sd=1)),
#                 list(lambda=rnorm(1,mean=0,sd=1)),
#                 list(lambda=rnorm(1,mean=0,sd=1)),
#                 list(lambda=rnorm(1,mean=0,sd=1)))
...
b1 <- b.fit.transform(data=b1.data,
                      model=model.s,
                      chains=5,
                      burnin=7000,
                      var.names=c("lambda"),
...
b2 <- b.fit.transform(data=b2.data,
                      model=model.s,
                      chains=5,
                      burnin=7000,
                      var.names=c("lambda"),
...
```{r 1.b(iii)}
# inits.h <- list(list(lambda=rnorm(1,mean=0,sd=1),
#                      a.0=rnorm(1,mean=0,sd=1),
#                      b.0=rnorm(1,mean=0,sd=1)),
#                 list(lambda=rnorm(1,mean=0,sd=1),
#                      a.0=rnorm(1,mean=0,sd=1),
#                      b.0=rnorm(1,mean=0,sd=1)),
#                 list(lambda=rnorm(1,mean=0,sd=1),
...
b3 <- b.fit.transform(data=b3.data,
                      model=model.h,
                      chains=5,
                      burnin=2000,
...
model.c1 <- "model{
 ...
 # Likelihood
  for(i in 1:n) {
      exp(mu[i]) <- beta0+beta1*(dist[i]-mean(dist[]))
      eartScot[i] ~ dpois(mu[i])
    } 
  }"
```
...
```{r 1.c}
# inits.c1 <- list(list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)))
...
```{r 1.d}
# inits.d1 <- list(list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
#                       sigma.delta=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
#                       sigma.delta=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
#                       sigma.delta=rnorm(1,mean=0,sd=1)),
...
```{r 1.e}
# inits.e1 <- list(list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)),
#                  list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1)))
...
AlgForest <- AlgForest %>%
  mutate(TempCels=c(TempCels-mean(TempCels)),
         RH=c(RH-mean(RH)),
         Ws=c(Ws-mean(Ws)),
         DMC=c(DMC-mean(DMC)),
         RainYest=c(RainYest-mean(RainYest)))
...
while(boolFalse==F){
  tryCatch({
    inits.c2 <- list(list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
                          beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
                          beta4=rnorm(1,mean=0,sd=1)),
                     list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
                          beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
                          beta4=rnorm(1,mean=0,sd=1)),
                     list(beta0=rnorm(1,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
    ...
    c2 <- b.fit.transform(inits=inits.c2,
                          data=c2.data,
                          model=model.c2,
                          chains=3,
                          burnin=2000,
    ...
    cat("Resetting initial values and rebuilding model")
  })
}
...
while(boolFalse==F){
  tryCatch({
    inits.d1 <- list(
      list(beta0=rnorm(2,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
           beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
           beta4=rnorm(1,mean=0,sd=1)),
      list(beta0=rnorm(2,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
           beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
    ...
    d1 <- b.fit.transform(inits=inits.d1,
                          data=d1.data,
                          model=model.d1,
                          chains=5,
                          burnin=7000,
...
AlgForest.month <- AlgForest.region %>% 
  mutate(month.b=if_else(month %in% c(7,8), "July&August","June&September"),
         ...
         Region.month.b=as.factor(paste(Region, month.b)))
...
d2.data <- list(n=length(AlgForest.month$Fire),
               ...
               Region.month.b=AlgForest.month$Region.month.b,
               J=2,
               K=4)
...
while(boolFalse==F){
  tryCatch({
    inits.d2 <- list(
      list(beta0=rnorm(4,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
           beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
           beta4=rnorm(1,mean=0,sd=1),beta5=rnorm(2,mean=0,sd=1)),
      list(beta0=rnorm(4,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
           beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
           beta4=rnorm(1,mean=0,sd=1),beta5=rnorm(2,mean=0,sd=1)),
      list(beta0=rnorm(4,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
    ...
    d2 <- b.fit.transform(inits=inits.d2,
                          data=d2.data,
                          model=model.d2,
                          chains=5,
                          burnin=2000,
                          var.names=c("beta0[1]", "beta0[2]", "beta0[3]", "beta0[4]",
...
while(boolFalse==F){
  tryCatch({
    # inits.d3 <- list(
    #   list(beta0=rnorm(8,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
    #        beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
    #        beta4=rnorm(1,mean=0,sd=1),omega=rnorm(8,mean=0,sd=1)),
    #   list(beta0=rnorm(8,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
    #        beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
    #        beta4=rnorm(1,mean=0,sd=1),omega=rnorm(8,mean=0,sd=1)),
    #   list(beta0=rnorm(8,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
    ...
    d3 <- b.fit.transform(data=d3.data,
                          ...
                          var.names=c("beta0[1]","beta0[2]","beta0[3]","beta0[4]",
                                      ...
                                      "beta1","beta2","beta3","beta4","omega.sigma2"),
                          total=5e4,
                          thin=100)
...
prob.d2.B.78 <- round(mean(inv.logit(results.d2.df$beta0.1.)),3)
prob.d2.B.69 <- round(mean(inv.logit(results.d2.df$beta0.2.)),3)
prob.d2.S.78 <- round(mean(inv.logit(results.d2.df$beta0.3.)),3)
prob.d2.S.69 <- round(mean(inv.logit(results.d2.df$beta0.4.)),3)

results.d2.df %>% 
  ggplot() +
  geom_density(aes(x=inv.logit(beta5.1.)), fill="red4"  , color="red4"  , alpha=0.5) +
  geom_density(aes(x=inv.logit(beta5.2.)), fill="green4", color="green4", alpha=0.5) +
...
while(boolFalse==F){
  tryCatch({
    inits.e1 <- list(
      list(beta0=rnorm(8,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
           beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
           beta4=rnorm(1,mean=0,sd=1),beta5=rnorm(1,mean=0,sd=1),omega=rnorm(1,mean=0,sd=1)),
      list(beta0=rnorm(8,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
           beta2=rnorm(1,mean=0,sd=1),beta3=rnorm(1,mean=0,sd=1),
           beta4=rnorm(1,mean=0,sd=1),beta5=rnorm(1,mean=0,sd=1),omega=rnorm(1,mean=0,sd=1)),
      list(beta0=rnorm(8,mean=0,sd=1),beta1=rnorm(1,mean=0,sd=1),
    ...
    e1 <- b.fit.transform(inits=inits.e1,
                          data=e1.data,
                          model=model.e1,
                          chains=5,
                          burnin=7000,
