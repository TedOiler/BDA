...
earthQ <- earthQ %>%
  mutate_at(vars(eartrUK, MLrUK, `nrUK>4.5`), ~scale(., center=T, scale=F))
...
b1 <- b.fit.transform(inits=inits.s,
                      data=b1.data,
                      model=model.s,
                      chains=5,
                      burnin=7000,
...
b2 <- b.fit.transform(inits=inits.s,
                      data=b2.data,
                      model=model.s,
                      chains=5,
                      burnin=7000,
...
c1 <- b.fit.transform(inits=inits.c1,
                      data=c1.data,
                      model=model.c1,
                      chains=5,
                      burnin=6000,
...
e2 <- b.fit.transform(inits=inits.e1,
                      data=e2.data,
                      model=model.e2,
                      chains=5,
                      burnin=6000,
...
AlgForest <- AlgForest %>%
  mutate_at(vars(TempCels, RH, Ws, DMC, RainYest), ~scale(., center=T, scale=T))
...
c2 <- b.fit.transform(inits=inits.d1,
                      data=c2.data,
                      model=model.c2,
                      chains=3,
                      burnin=2000,
...
while(boolFalse==F){
  tryCatch({
    ...
    d3 <- b.fit.transform(inits=inits.d3,
                          data=d3.data,
                          model=model.d3,
                          chains=5,
                          burnin=2000,
